...
if (isset($_POST['submit'])) {
    ...
    $dept = mysqli_real_escape_string($conn, $_POST['dept']); // Fixed name
    $work = mysqli_real_escape_string($conn, $_POST['work']); // Fixed name
    $pos = mysqli_real_escape_string($conn, $_POST['pos']); // Fixed name
    $gender = mysqli_real_escape_string($conn, $_POST['gender']);
    $addr = mysqli_real_escape_string($conn, $_POST['addr']); // Fixed name
    ...
    if (mysqli_query($conn, $insert)) {
        // session_destroy(); // Avoid destroying session here
        ...
        <form action="" method="POST">
            ...
            <div class="form-container">
                ...
                <div class="input-name">
                    ...
                    <label for="cb" class="check">I have already filled this form <a href="login.php">Login</a></label>
                </div>
            </div>
        </form>
    </div>
